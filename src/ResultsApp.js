				...
				<div className="text-vertical-center" style={{marginTop:'100px'}}>
            		...
            		<div className="row" style={{}}>
                    	...
                    	<div className="case_law_card card tab-content" id="2061">
                    			<img src="http://localhost:3000/static/media/like.09ae610a.svg" className="heartImg" alt="l"/>
                        ...
                        <p id="loading">
                            <img src="http://localhost:3000/static/media/Loading.f4404720.gif" style={{width: '20%'}} alt="Loading…" />
                        </p>
                    	</div>
                    </div>
                </div>
